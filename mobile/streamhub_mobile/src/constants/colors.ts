export const Colors = {
  ...
  gradientHero: ['rgba(7,9,15,0)', 'rgba(7,9,15,0.7)', '#07090F'] as string[],
  gradientCard: ['rgba(7,9,15,0)', 'rgba(7,9,15,0.95)'] as string[],
  gradientAccent: ['#6366F1', '#4338CA'] as string[],
} as const;
